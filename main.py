...
async def process_data(message: Message, state: FSMContext):
    ...
    if message.from_user.username:
        ...
        await bot.send_photo(
            ...
            photo=data['photo'], 
            caption=data['info'])
    await bot.send_message(message.chat.id, 'Спасибо!', reply_markup=Keyboard.get_keyboard())
...
5. Можно приступить к программе в любое удобное для вас время.
    """
    await bot.send_message(cq.message.chat.id, msg, reply_markup=Keyboard.get_faq_keyboard())
